...
import java.util.*
import no.nav.poao_tilgang.core.policy.NavAnsattTilgangTilEksternBrukerKjernereglerPolicy

class NavAnsattTilgangTilEksternBrukerKjernereglerPolicyImplTest {
	...
	private val policy = NavAnsattTilgangTilEksternBrukerKjernereglerPolicyImpl(
	...
	internal fun `harTilgang should return PERMIT for LESE`() {
		...
		val decision =
			policy.harTilgang(NavAnsattTilgangTilEksternBrukerKjernereglerPolicy.Input(navAnsattAzureId, LESE, norskIdent))

		verifyAll {
			tilgangsMaskinProvider.evaluerKjerneregler(norskIdent, navIdent)
	...
	internal fun `harTilgang should return PERMIT for SKRIVE`() {
		...
		val decision =
			policy.harTilgang(NavAnsattTilgangTilEksternBrukerKjernereglerPolicy.Input(navAnsattAzureId, SKRIVE, norskIdent))
